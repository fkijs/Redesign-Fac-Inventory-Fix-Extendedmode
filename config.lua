...
Config.Shops = {
    RegularShop = {
     ...
     --       { x = 268.26, y = -979.44, z = 28.37 },
        ...
        Items = {
            ...
            { name = 'cigarette',price = 70 },
            { name = 'hamburger',price = 70 },
            { name = 'icetea',price = 70 },
            { name = 'milk',price = 70 },
            { name = 'cocacola',price = 70 },
            { name = "blue_phone", price = 250 },
            { name = "green_phone", price = 250 },
    ...
    RobsLiquor = {
        ...
        Items = {
            ...
            { name = 'water',price = 1 },
            { name = 'icetea',price = 1 },
            { name = 'cocacola',price = 1 },
            { name = 'gintonic',price = 1},
            { name = 'champagne',price = 1},
            { name = 'absinthe',price = 1},
    ...
    WeaponShop = {
        ...
        Items = {
            ...
            { name = "WEAPON_MACHETE", price = 4500},
